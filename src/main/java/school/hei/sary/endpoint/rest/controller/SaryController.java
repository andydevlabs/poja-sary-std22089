...
public class SaryController {
  private final BucketComponent bucketComponent;
    ...
    @PutMapping("/sary/")
  public ResponseEntity<?> uploadFile(@RequestParam("file") File file, @RequestParam("bucketKey") String bucketKey) {
    try {
  ...
  public ResponseEntity<?> downloadFile(@PathVariable String bucketKey) {
    try {
      URL presignedUrl = bucketComponent.presign(bucketKey, Duration.ofMinutes(10)); // Adjust expiration as needed
